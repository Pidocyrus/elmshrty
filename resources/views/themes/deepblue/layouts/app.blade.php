            ...
            <div class="navbar navbar-expand-md flex-wrap">
                ...
                <div class="collapse navbar-collapse" id="investmentnavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('plan')}}">{{trans('Business Design')}}</a>
                        </li>

                        @auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('user.home')}}">@lang('Cockpit Console')</a>
                            </li>
                        @endauth
                    </ul>
                        ...
                        <div class="dropdown account-dropdown responsive-menus">
                            ...
                            <div class="xs-dropdown-menu xs-dropdown-menu1 dropdown-menu dropdown-right">
                                <div class="dropdown-content">
                                    ...
                                    <a class="dropdown-item" href="{{route('plan')}}">{{trans('Business Design')}}</a>

                ...
                <div class="collapse navbar-collapse" id="investmentnavbar">
                    <ul class="navbar-nav">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('user.home')); ?>"><?php echo app('translator')->get('Cockpit Console'); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
...
<?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/layouts/app.blade.php ENDPATH**/ ?>
<!-- FOOTER -->
    <div class="copy-rights">
        <div class="container">
                 <a href="<?php echo e(route('home')); ?>"><i class="icofont-thin-right"></i> <?php echo app('translator')->get('Return to Home'); ?></a>
...
<?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/partials/footer.blade.php ENDPATH**/ ?>
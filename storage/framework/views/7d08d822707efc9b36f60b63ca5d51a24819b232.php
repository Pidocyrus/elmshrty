<?php $__env->startSection('title',trans('Cockpit Console')); ?>
<?php $__env->startSection('content'); ?>
                ...
                <div aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)"
                                                       class="cursor-inherit"><?php echo e(trans('Cockpit Console')); ?></a></li>
                    </ol>
                </div>
            </div>
        </section>
    ...
    <section id="dashboard">
        <div class="dashboard-wrapper wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.35s">
                        ...
                        <div class="content-wrapper">
                            <div class="content-container">
                                <div class="content-main-block d-flex h-fill">
                                    ...
                                    <div class="content-block flex-fill d-flex flex-column justify-content-center">
                                        <h6 class="h6 font-weight-medium"><?php echo app('translator')->get('Dividend'); ?></h6>
                                        <h4 class="h4 mt-10">
                        ...
                        <div class="content-wrapper">
                            <div class="content-container">
                                <div class="content-main-block d-flex h-fill">
                                    ...
                                    <div class="content-block flex-fill d-flex flex-column justify-content-center">
                                        <h6 class="h6 font-weight-medium"><?php echo app('translator')->get('Total Gross'); ?></h6>
                                        <h4 class="h4 mt-10">
                        ...
                        <div class="progress-wrapper">
                            <div class="progress-container d-flex flex-column flex-sm-row justify-content-start">
                                ...
                                <div class="circular-progress cp_1">
                                    ...
                                    <h6 class="h6 text-center"><?php echo app('translator')->get('Invest Fulfilled'); ?></h6>
                                </div>
                                ...
                                <div class="circular-progress cp_3">
                                    ...
                                    <h6 class="h6 text-center"><?php echo app('translator')->get('ROI Rate'); ?></h6>
                                </div>
            ...
            <h4 class="h4 text-center mt-50 mb-50"><?php echo app('translator')->get('Balance Sheet'); ?></h4>
                        ...
                        <div class="content-wrapper">
                            <div class="content-container">
                                <div class="d-flex flex-column align-items-center h-fill">
                                    ...
                                    <div
                                        class="content-block flex-fill d-flex flex-column justify-content-center text-center">
                                        <h6 class="h6 mt-15 mb-15 font-weight-medium"><?php echo app('translator')->get('Total Conversation'); ?></h6>
                        ...
                        <div class="content-wrapper">
                            <div class="content-container">
                                <div class="d-flex flex-column align-items-center h-fill">
                                    ...
                                    <div
                                        class="content-block flex-fill d-flex flex-column justify-content-center text-center">
                                        <h6 class="h6 mt-15 mb-15 font-weight-medium"><?php echo app('translator')->get('Total Referral Benefit'); ?></h6>
                ...
                <div class="row mb-50">
                    <div class="col-xl-<?php echo e(($latestRegisteredUser) ? '12':'6'); ?>">
                        <div class="form-group form-block mb-50 pr-15 pl-15">
                            <h5 class="mb-15"><?php echo app('translator')->get('Referral Url'); ?></h5>
                                ...
                                <div class="content-container d-flex">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body ml-20">
                                            <h5 class="mb-15"><?php echo app('translator')->get('Your Last Registered Partner'); ?></h5>
                        ...
                        <div class="content-wrapper bg-5">
                            ...
                            <div class="content-container d-flex">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ml-20">
                                        <h5 class="mb-15"><?php echo app('translator')->get('Your last Referral Benefit'); ?></h5>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/user/dashboard.blade.php ENDPATH**/ ?>
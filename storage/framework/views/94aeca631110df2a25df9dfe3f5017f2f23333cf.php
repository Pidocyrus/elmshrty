                ...
                <form class="login-form" id="invest-form" action="<?php echo e(route('user.purchase-plan')); ?>" method="post">
                    ...
                    <div class="signin ">
                        ...
                        <div class="btn-area mb-30">
                            <button class="btn-login login-auth-btn" type="submit"><span><?php echo app('translator')->get('Purchase Design'); ?></span>
                            </button>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/sections/investment.blade.php ENDPATH**/ ?>
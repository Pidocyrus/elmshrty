        ...
        <div class="container-fluid">
            <div aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)"><?php echo app('translator')->get('Payment'); ?></a></li>
                </ol>
            </div>
        </div>
    </section>
                    ...
                    <div class="modal-body ">
                        <div class="payment-form ">
                            ...
                            <div class="form-group mb-30">
                                <label><?php echo app('translator')->get('Business Design Name'); ?></label>
                                <input type="text" class=" form-control" value="<?php echo e($plan->name); ?>" readonly>
                            </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/user/payment.blade.php ENDPATH**/ ?>
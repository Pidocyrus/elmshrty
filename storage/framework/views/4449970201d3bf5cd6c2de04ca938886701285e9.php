...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="submit-btn-wrapper text-center text-md-left">
                                                    <button type="submit"
                                                            class="  btn btn-primary base-btn btn-block btn-rounded"><?php echo app('translator')->get('Submit'); ?></button>
                                                </div>
                                            <?php endif; ?>
                                        </form>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/user/profile/myprofile.blade.php ENDPATH**/ ?>
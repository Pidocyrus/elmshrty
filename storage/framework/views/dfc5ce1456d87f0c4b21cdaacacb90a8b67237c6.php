            ...
            <div class="dropdown-content">
                ...
                <a class="dropdown-item" href="<?php echo e(route('user.home')); ?>">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body ml-15">
                            <h6 class="font-weight-bold"><?php echo e(trans('Cockpit Console')); ?></h6>
                        </div>
                    </div>
                </a>
                ...
                <a class="dropdown-item"  href="javascript:void(0)">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body ml-15">
                            <h6 class="font-weight-bold"><?php echo e(trans('Dividend')); ?></h6>
...
<?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/partials/profile-menu.blade.php ENDPATH**/ ?>
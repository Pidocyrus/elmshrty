<?php $__env->startSection('title',trans('Business Design')); ?>
                    ...
                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="<?php if(auth()->guard()->check()): ?> col-md-6 col-lg-4 col-xl-3 <?php else: ?> col-md-6 col-lg-4 <?php endif; ?>  ">
                            <div class="card-type-1 card align-items-start wow fadeInUp" data-wow-duration="1s"
                                ...
                                <p class="text">
                                    <?php echo app('translator')->get('Capital return'); ?> :
                                ...
                                <button class="btn-base text-uppercase mt-30 investNow" type="button"
                                        ...
                                        data-resource="<?php echo e($data); ?>"><?php echo app('translator')->get('Purchase Design'); ?></button>
                            </div>
                        </div>
                    ...
                    <form class="login-form" id="invest-form" action="<?php echo e(route('user.purchase-plan')); ?>" method="post">
                        ...
                        <div class="signin ">
                            ...
                            <div class="btn-area mb-30">
                                <button class="btn-login login-auth-btn" type="submit"><span><?php echo app('translator')->get('Purcahse Design'); ?></span>
                                </button>
                            </div>
...
<?php echo $__env->make($extend_blade, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elmshrty/public_html/resources/views/themes/deepblue/plan.blade.php ENDPATH**/ ?>